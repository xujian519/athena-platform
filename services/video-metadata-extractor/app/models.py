...
class VideoMetadata(BaseModel):
    ...
    author: Optional[str] = Field(None, description='作者/UP主')
    ...
    category: Optional[str] = Field(None, description='视频分类')
...
class ExtractionRequest(BaseModel):
    ...
    platform: Optional[VideoPlatform] = Field(None, description='指定平台，不指定则自动检测')
...
class ExtractionResult(BaseModel):
    ...
    metadata: Optional[VideoMetadata] = Field(None, description='视频元信息')
