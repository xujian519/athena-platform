...
from arango.exceptions import DocumentGetError, CollectionCreateError
...
class ArangoGraphEngine:
    ...
    def get_graph_statistics(self, graph_type: GraphType):
        ...
        try:
            ...
            type_distribution = [doc for doc in cursor]
            ...
            relation_distribution = [doc for doc in cursor]
