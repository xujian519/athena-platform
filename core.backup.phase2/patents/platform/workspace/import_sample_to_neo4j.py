...
def main():
    ...
    try:
        ...
        if import_stats['success']:
            ...
            logger.info(f"   2. 查询样本数据: MATCH (e:Entity) RETURN e LIMIT 10")
            logger.info(f"   3. 查看关系网络: MATCH (e1)-[r]->(e2) RETURN e1, r, e2 LIMIT 5")
            logger.info(f"   4. 分析质量分层: MATCH (e) RETURN e.quality_layer, count(e)")
