...
# Chapter 5: Tool Use (Function Calling) | <mark></mark>

## Tool Use Pattern Overview | <mark></mark>
...
<mark>Function Calling API、、。。</mark>
...
<mark>LangChain、LangGraph Google ADK Gemini OpenAI 。。</mark>
...
[Colab ](https://colab.research.google.com/drive/1PNsMB2kcCP-iPgpYamG11bGkBiP3QViz#scrollTo=FW3Eh5_OjUea) [](/codes/Chapter-05-Tool-Use-LangChain-Example.py)。
...
<mark> LangChain Google Gemini 。</mark>

<mark> <code>search_information</code> 「」、「」「」。</mark>

<mark> <code>ChatGoogleGenerativeAI</code> <code>ChatPromptTemplate</code>。 <code>create_tool_calling_agent</code> 、 <code>AgentExecutor</code> 。</mark>

<mark> <code>run_agent_with_tool</code>。 <code>main</code> <code>search_information</code> 。</mark>

<mark> <code>asyncio.run(main())</code> 。</mark>
...
[Colab ](https://colab.research.google.com/drive/1TBcatcgnntrm31kfIzENsSMNYwMNLUOh) [](/codes/Chapter-05-Tool-Use-CrewAI-Example.py)。
...
<mark> <code>get_stock_price</code> <code>ValueError</code> 。</mark>

<mark> <code>financial_analyst_agent</code> Crew.ai <code>get_stock_price</code> 。</mark>

<mark> <code>analyze_aapl_task</code> AAPL。</mark>

<mark> <code>financial_analyst_agent</code> <code>analyze_aapl_task</code> <code>Crew</code> <code>verbose</code> true 。</mark>

<mark> <code>if __name__ == "__main__":</code> <code>kickoff()</code> Crew 。 Crew <code>OPENAI_API_KEY</code> 。</mark>

<mark>Crew 。 Crew 。 API 。</mark>

<mark> Crew.ai 、。</mark>

---

## Hands-on code (Google ADK) | <mark> Google ADK</mark>
...
<mark><strong>Google </strong>Google Google 。</mark>
...
tools=[google_search] # Google Search is a pre-built tool to perform Google searches. Google Search Google 。
)
...
[Colab ](https://colab.research.google.com/drive/1qFpzmHYomA4vbtuuV1DJrW_cpAZAbY_m) [](/codes/Chapter-05-Tool-Use-ADK-Example-Google-Search.py)。
...
<mark> Python Google ADK Google 。</mark>

<mark> <code>IPython</code>、<code>google.adk</code> <code>google.genai</code> 、 ID ID 。</mark>

<mark><code>basic_search_agent</code> ADK Google 。</mark>

<mark> <code>InMemorySessionService</code>、 ID 。 <code>Runner</code> 。 <code>call_agent</code> 「user」 <code>types.Content</code> ID、 ID <code>runner.run</code> 。。。</mark>

<mark>「what's the latest ai news?」 <code>call_agent</code> 。</mark>
...
<mark><strong></strong>Google ADK 。<code>built_in_code_execution</code> Python 、。。</mark>
...
[Colab ](https://colab.research.google.com/drive/1iF4I_mkV_as0fYoVBuKtf5gfTONEySfK) [](/codes/Chapter-05-Tool-Use-ADK-Example-Code-Execution.py)。
...
<mark> Google ADK Python 。</mark>

<mark> <code>code_agent</code> <code>built_in_code_execution</code> 。</mark>

<mark> <code>call_agent_async</code> 。 Python 。。</mark>

<mark><code>main</code> 。</mark>
...
<mark><strong></strong> Python <code>google.adk</code> Google ADK <code>VSearchAgent</code> Vertex AI Search 。</mark>

<mark> <code>q2_strategy_vsearch_agent</code> <code>VSearchAgent</code> 、gemini-2.0-flash-exp Vertex AI Search ID <code>DATASTORE_ID</code> 。</mark>

<mark> <code>Runner</code> <code>InMemorySessionService</code> 。</mark>

<mark> <code>call_vsearch_agent_async</code> <code>run_async</code> 。</mark>

<mark>。 ID 。</mark>

<mark> <code>run_vsearch_example</code> 。 <code>DATASTORE_ID</code> <code>asyncio.run</code> 。 Jupyter notebook。</mark>
...
[Colab ](https://colab.research.google.com/drive/1AhF4Jam8wuYMEYU27y22r1uTbixs9MSE) [](/codes/Chapter-05-Tool-Use-ADK-Example-AI-Search.py)。
...
<mark><strong>Vertex Vertex AI 。、、、。Google Vertex AI Search 。 Google 。Vertex AI 。</strong></mark>
...
<mark>LangChain <code>@tool</code> <code>create_tool_calling_agent</code> <code>AgentExecutor</code> 。</mark>

- Google ADK has a number of very useful pre-built tools such as Google Search, Code Execution and Vertex AI Search Tool.

<mark>Google ADK Google 、 Vertex AI Search 。</mark>
...
<mark> LangChain、Google ADK Crew AI 。、。</mark>
...
<mark>LangChain <https://python.langchain.com/docs/integrations/tools/></mark>

2. Google Agent Developer Kit (ADK) Documentation (Tools): <https://google.github.io/adk-docs/tools/>

<mark>Google ADK<https://google.github.io/adk-docs/tools/></mark>

3. OpenAI Function Calling Documentation: <https://platform.openai.com/docs/guides/function-calling>

<mark>OpenAI <https://platform.openai.com/docs/guides/function-calling></mark>

4. CrewAI Documentation (Tools): <https://docs.crewai.com/concepts/tools>

<mark>CrewAI <https://docs.crewai.com/concepts/tools></mark>
