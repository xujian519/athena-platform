...
from tech_feature_extractor import technical_feature_extractor
...
class SemanticEnhancedFeatureExtractor:
    ...
    def compare_claims(self, claim1: ClaimAnalysisResult,
        ...
        # 特征重叠度
        features1_text = {f.text for f in claim1.enhanced_features}
        features2_text = {f.text for f in claim2.enhanced_features}
