...
class ConversationManager:
    ...
    def create_conversation(self, user_id: str, patent_context: dict[str, Any] | None = None) -> str:
        """创建新对话"""
...
"""
    ...
    async def start_conversation(self, user_id: str, patent_context: dict[str, Any] | None = None) -> str:
        """开始新对话"""
