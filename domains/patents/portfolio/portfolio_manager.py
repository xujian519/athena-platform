...
try:
    from .maintenance_decider import MaintenanceDecision, MaintenanceDecisionMaker
    from .patent_classifier import ClassificationResult, GradingResult, PatentClassifier
    from .patent_list_manager import PatentListManager, PatentRecord
    from .value_assessor import ValueAssessment, ValueAssessor
except ImportError:
    from core.patents.portfolio.maintenance_decider import (
        MaintenanceDecisionMaker,
    )
    from core.patents.portfolio.patent_classifier import (
        PatentClassifier,
    )
    from core.patents.portfolio.patent_list_manager import PatentListManager, PatentRecord
    from core.patents.portfolio.value_assessor import ValueAssessor
