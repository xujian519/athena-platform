...
try:
    ...
    from core.patents.infringement.claim_parser import ClaimParser
    from core.patents.infringement.feature_comparator import FeatureComparator
    from core.patents.infringement.infringement_determiner import (
        InfringementDeterminer,
    )
    from core.patents.infringement.opinion_writer import OpinionWriter
    from core.patents.infringement.product_analyzer import ProductAnalyzer
...
class InfringementAnalyzer:
    ...
    async def analyze_infringement(
        ...
        options: InfringementAnalysisOptions | None = None
