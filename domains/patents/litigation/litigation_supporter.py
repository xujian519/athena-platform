...
try:
    from .evidence_organizer import EvidenceOrganizationResult, EvidenceOrganizer
    ...
    from .pleading_generator import PleadingGenerator, PleadingResult, PleadingType
    from .trial_assistant import TrialAssistant, TrialPreparationGuide
except ImportError:
    ...
    from core.patents.litigation.trial_assistant import TrialAssistant, TrialPreparationGuide
...
class LitigationSupportResult:
    ...
    case_number: str
    litigation_type: str
    strategy_analysis: CaseAnalysis | None = None
    evidence_organization: EvidenceOrganizationResult | None = None
    pleading_result: PleadingResult | None = None
    trial_preparation: TrialPreparationGuide | None = None
...
class LitigationSupporter:
    ...
    async def support_litigation(
        ...
        pleading_arguments: list[dict[str, Any] | None = None,
        options: LitigationSupportOptions | None = None
