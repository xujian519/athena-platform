...
- [Core Principles | 核心原则](#core-principles--核心原则)
  - [1. Accuracy and Faithfulness | 准确性和忠实性](#1-accuracy-and-faithfulness--准确性和忠实性)
  - [2. Readability and Localization | 可读性和本土化](#2-readability-and-localization--可读性和本土化)
    - [翻译质量标准（信雅达原则）](#翻译质量标准信雅达原则)
    - [具体实践](#具体实践)
    - [常见问题避免](#常见问题避免)
- [Format Requirements | 格式要求](#format-requirements--格式要求)
  - [1. Document Structure | 文档结构](#1-document-structure--文档结构)
    - [章节标题格式](#章节标题格式)
- [Section Title | <mark>章节标题</mark>](#section-title--mark章节标题mark)
- [At a Glance | <mark>要点速览</mark>](#at-a-glance--mark要点速览mark)
    - [章节固定术语翻译](#章节固定术语翻译)
  - [2. Markdown Syntax | Markdown 语法](#2-markdown-syntax--markdown-语法)
  - [3. Bilingual Layout | 双语布局](#3-bilingual-layout--双语布局)
    - [For Short Content (致谢等短章节)](#for-short-content-致谢等短章节)
- [English | 英文](#english--英文)
- [Chinese | 中文](#chinese--中文)
    - [For Long Content (正文章节等)](#for-long-content-正文章节等)
  - [4. Highlighting System | 高亮系统](#4-highlighting-system--高亮系统)
    - [主要方案（推荐）](#主要方案推荐)
    - [特殊场景格式](#特殊场景格式)
  - [5. Mark + Markdown Rendering | 高亮与 Markdown 渲染](#5-mark--markdown-rendering--高亮与-markdown-渲染)
    - [参考文献格式](#参考文献格式)
  - [6. Lists & Emphasis Patterns | 列表与强调规范](#6-lists--emphasis-patterns--列表与强调规范)
  - [7. Names, Titles & Captions | 姓名、头衔与标题](#7-names-titles--captions--姓名头衔与标题)
  - [8. Tone & Pronouns | 语气与人称](#8-tone--pronouns--语气与人称)
  - [9. Quick QA Checks | 快速自检](#9-quick-qa-checks--快速自检)
    - [格式检查](#格式检查)
    - [标点检查](#标点检查)
    - [术语检查](#术语检查)
    - [质量检查](#质量检查)
  - [10. PR Review Checklist | PR 审阅清单](#10-pr-review-checklist--pr-审阅清单)
    - [内容质量](#内容质量)
    - [格式规范](#格式规范)
    - [术语统一](#术语统一)
    - [标点符号](#标点符号)
    - [其他检查](#其他检查)
- [Translation Guidelines | 翻译指南](#translation-guidelines--翻译指南)
  - [1. Technical Terms | 技术术语](#1-technical-terms--技术术语)
    - [核心术语统一](#核心术语统一)
    - [翻译原则](#翻译原则)
    - [禁用术语](#禁用术语)
    - [术语一致性检查](#术语一致性检查)
    - [代码术语格式化](#代码术语格式化)
  - [2. Spacing Rules | 空格规则](#2-spacing-rules--空格规则)
  - [3. Punctuation | 标点符号](#3-punctuation--标点符号)
    - [基本规则](#基本规则)
    - [引号规范](#引号规范)
    - [括号规范](#括号规范)
    - [破折号与连接号](#破折号与连接号)
    - [顿号与逗号](#顿号与逗号)
    - [冒号使用](#冒号使用)
  - [4. Cultural Adaptation | 文化适配](#4-cultural-adaptation--文化适配)
- [Quality Control | 质量控制](#quality-control--质量控制)
  - [1. Review Process | 审校流程](#1-review-process--审校流程)
  - [2. Consistency Checks | 一致性检查](#2-consistency-checks--一致性检查)
- [File Naming Convention | 文件命名规范](#file-naming-convention--文件命名规范)
- [Git Workflow | Git 工作流程](#git-workflow--git-工作流程)
  - [1. Commit Messages | 提交信息](#1-commit-messages--提交信息)
  - [2. File Organization | 文件组织](#2-file-organization--文件组织)
- [Common Translation Patterns | 常用翻译模式](#common-translation-patterns--常用翻译模式)
  - [Technical Terms Dictionary | 技术术语词典](#technical-terms-dictionary--技术术语词典)
- [Quality Standards | 质量标准](#quality-standards--质量标准)
  - [1. Translation Quality | 翻译质量](#1-translation-quality--翻译质量)
    - [信雅达三重标准](#信雅达三重标准)
    - [常见问题及修正示例](#常见问题及修正示例)
  - [2. Format Compliance | 格式合规性](#2-format-compliance--格式合规性)
  - [3. Consistency | 一致性](#3-consistency--一致性)
...
- 需要中英文并列的行内强调时， 中文放 `<mark>` 内， 英文保持原样；
不要在 `<mark>` 内再嵌套 Markdown 语法。
