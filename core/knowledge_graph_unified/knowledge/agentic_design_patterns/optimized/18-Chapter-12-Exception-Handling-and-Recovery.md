...
# 📚 18 Chapter 12 Exception Handling And Recovery

> **文件路径**: `18-Chapter-12-Exception-Handling-and-Recovery.md`
...
<mark>简而言之， 要构建一个不仅智能， 还能在面对现实世界的复杂性时， 能够可靠、有韧性且用户友好的智能体， 该模式就其基础。
</mark>
