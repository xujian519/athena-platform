...
# Chapter 11: Goal Setting and Monitoring | <mark> 11 </mark>
...
## Goal Setting and Monitoring Pattern Overview | <mark></mark>
...
<mark> LangChain OpenAI API 。 Python AI Python 。。</mark>
...
```
[Colab ](https://colab.research.google.com/drive/1553L0BIxqhPFS6RHiLnF_ELjEkWZpqsC?usp=drive_open) [](/codes/17-Chapter-11-Goal-Setting-and-Monitoring-Example.py)。
...
<mark>“False”AI 。。、。 AI “True” - 。 Python 。</mark>
...
<mark>SMART [https://en.wikipedia.org/wiki/SMART\_criteria](https://en.wikipedia.org/wiki/SMART_criteria) </mark>
