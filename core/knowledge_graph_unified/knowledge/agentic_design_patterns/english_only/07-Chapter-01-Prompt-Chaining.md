...
# Chapter 1: Prompt Chaining | <mark></mark>

## Prompt Chaining Pattern Overview | <mark></mark>
...
<mark><strong></strong>。、contextual drift、、。</mark>
...
<mark><strong></strong>。。 JSON XML。</mark>
...
<mark>、。 LangChain、LangGraph、Crew AI ADK。</mark>
...
<mark>LangChain LangGraph API ChainsGraphs。LangChain LangGraph 。。</mark>
...
<mark>langchain-openai 。 OpenAI、Google Gemini Anthropic API 。</mark>

[Colab ](https://colab.research.google.com/drive/15XCzDOvBhIQaZ__xkvruf5sP9OznAbK9) [](/codes/Chapter-01-Prompt-Chaining-Example.py)。
...
<mark> Python LangChain 。 JSON 。ChatOpenAI StrOutputParser 。LangChain LCEL | 「」。 extraction_chain。full_chain 。 invoke full_chain JSON 。</mark>

---

## Context Engineering and Prompt Engineering | <mark></mark>
...
<mark>Context Engineering 1 AI Token、。。</mark>
...
<mark>Prompt Engineering。。<strong>System Prompt</strong> AI 「」。</mark>
...
<mark>LangChain LCEL [https://python.langchain.com/v0.2/docs/core_modules/expression_language/](https://python.langchain.com/v0.2/docs/core_modules/expression_language/)</mark>

2. LangGraph Documentation: [https://langchain-ai.github.io/langgraph/](https://langchain-ai.github.io/langgraph/)

<mark>LangGraph [https://langchain-ai.github.io/langgraph/](https://langchain-ai.github.io/langgraph/)</mark>
...
<mark> - [https://www.promptingguide.ai/techniques/chaining](https://www.promptingguide.ai/techniques/chaining)</mark>
...
<mark>OpenAI API [https://platform.openai.com/docs/guides/gpt/prompting](https://platform.openai.com/docs/guides/gpt/prompting)</mark>

5. Crew AI Documentation: [https://docs.crewai.com/](https://docs.crewai.com/)

<mark>Crew AI [https://docs.crewai.com/](https://docs.crewai.com/)</mark>
...
<mark> AI [https://cloud.google.com/discover/what-is-prompt-engineering?hl=en](https://cloud.google.com/discover/what-is-prompt-engineering?hl=en)</mark>
...
<mark>Vertex AI [https://cloud.google.com/vertex-ai/generative-ai/docs/learn/prompts/prompt-optimizer](https://cloud.google.com/vertex-ai/generative-ai/docs/learn/prompts/prompt-optimizer)</mark>
