...
# Appendix C - Quick overview of Agentic Frameworks | <mark>C: </mark>
...
<mark>LangChain(LLM)。LangChain(LCEL)“”。。(DAG)。</mark>

Use it for: <mark></mark>
...
<mark>LangGraphLangChain。LCEL。、。。</mark>
...
Which One Should You Use? <mark></mark>
...
<mark>、LangChain。AB、CLangChainLCEL。</mark>
...
<mark>ADKAI。LangChainLangGraphADK。</mark>
...
<mark>Google ADK。。ADKSequentialAgentParallelAgent。“”。LangGraph。LangGraphGoogle ADK 。</mark>
...
<mark>CrewAI 。CrewAI 。CrewAI。</mark>
...
<mark>CrewAI。LangGraph、LangGraph。CrewAI。Google ADK 、CrewAI。</mark>
...
## Other agent development framework | <mark></mark>
...
<mark>Microsoft AutoGenAutoGen。。AutoGen、。。</mark>
...
<mark>LlamaIndexLlamaIndex。RAG、、。。LlamaIndex。</mark>
...
<mark>HaystackHaystack、。、、。Haystack。。</mark>
...
<mark>MetaGPTMetaGPT (SOP) 。。SOP。。</mark>
...
<mark>Semantic Kernel (SDK)“”“”。。 .NET Python 。。</mark>
...
<mark>Strands Agents AWS SDK AI 。。 (LLM) MCP 。。。</mark>
...
<mark>。LangChainLangGraph。CrewAIGoogle ADKLlamaIndex。。、。AI。</mark>
