...
# Chapter 14: Knowledge Retrieval (RAG) | <mark> 14 RAG</mark>
...
---
## Knowledge Retrieval (RAG) Pattern Overview | <mark>RAG</mark>
...
<mark> RAG AI Prompt LLM。——、——。「」。「」。「」 Prompt 、。 Prompt LLM。LLM 。</mark>
...
<mark><strong>Embeddings</strong> LLM 、。。。。「cat」 (2, 3) 「kitten」 (2.1, 3.1)。「car」 (8, 1)。。</mark>
...
<mark>「What is the capital of France?」「Which city is the capital of France?」。。。</mark>
...
<mark><strong></strong>、「」chunks。 RAG LLM。。</mark>
...
<mark> HNSW - Hierarchical Navigable Small World「」。 RAG 。。</mark>
...
<mark> Pinecone Weaviate Chroma DB、Milvus Qdrant 。 Redis、Elasticsearch Postgres pgvector 。 Meta AI FAISS Google Research ScaNN 。</mark>
...
<mark><strong> RAGGraph RAG</strong>GraphRAG RAG 。。 RAG 。GraphRAG 、。</mark>
...
<mark>、。、。。。GraphRAG 。GraphRAG RAG 。</mark>
...
<mark><strong> RAGAgentic RAG</strong> RAG 2。「」—— AI ——。、。</mark>
...
<mark>。「」 RAG 2020 2025 。 2025 、 LLM 。</mark>
...
<mark>。「Alpha 」 50,000 65,000 。 RAG LLM 。</mark>
...
<mark><strong></strong> RAG 。、、。 AI 、。</mark>
...
---
## Hands-On Code Example (ADK) | <mark> ADK </mark>
...
<mark> Google Search RAG LLM 。 RAG Google Search LLM 。</mark>
...
<mark> Google ADK Vertex AI RAG 。 ADK <code>VertexAiRagMemoryService</code>。 Google Cloud Vertex AI RAG 。 SIMILARITY_TOP_K VECTOR_DISTANCE_THRESHOLD。。SIMILARITY_TOP_K 。VECTOR_DISTANCE_THRESHOLD 。 RAG 。 Google Cloud RAG ADK 。</mark>
...
<mark> Python LangChain LangGraph RAG。。 Weaviate 。</mark>
...
<mark>LangGraph StateGraph <code>retrieve_documents_node</code> <code>generate_response_node</code>。<code>retrieve_documents_node</code> 。<code>generate_response_node</code> OpenAI LLM。<code>app.stream</code> RAG 。</mark>
...
<mark><strong></strong>RAG LLM 。。。 LLM、。 LLM 「」「」。</mark>
...
<mark><strong></strong> LLM 、 RAG 。、、。</mark>

## Visual Summary | <mark></mark>
...
<mark>。。。RAG AI 、、。 LLM 「」、「」。</mark>

---
## References | <mark></mark>
Lewis, P., et al. (2020). Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks. https://arxiv.org/abs/2005.11401
<mark>Lewis, P., et al. (2020)。。https://arxiv.org/abs/2005.11401</mark>
...
<mark>Google AI 。 - https://cloud.google.com/vertex-ai/generative-ai/docs/rag-engine/rag-overview</mark>

Retrieval-Augmented Generation with Graphs (GraphRAG), https://arxiv.org/abs/2501.00309
<mark> (GraphRAG), https://arxiv.org/abs/2501.00309</mark>
...
<mark>LangChain LangGraphLeonie Monigatti「RAG LangChain 」https://medium.com/data-science/retrieval-augmented-generation-rag-from-theory-to-langchain-implementation-4e9bd5f6a4f2</mark>
...
<mark>Google Cloud Vertex AI RAG https://cloud.google.com/vertex-ai/generative-ai/docs/rag-engine/manage-your-rag-corpus#corpus-management</mark>
