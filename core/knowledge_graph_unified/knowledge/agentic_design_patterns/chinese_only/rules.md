...
本项目旨在将完整翻译为中英文对照版本， 为中文读者提供优质的智能体设计模式学习资源
...
在中文翻译中引用代码组件类名函数名变量名时， 应使用标签包裹， 以提高可读性和专业性
...
```markdown
错误： 代码从和导入了关键模块， 包含等组件

正确： 代码从和导入了关键模块， 包含等组件
```
...
问题类型错误示例正确示例
过度诗化一束全新而灿烂的光全新而灿烂的光
生硬直译在岗精进的智能助理边做边学的智能助理
笔误可可靠达成能够可靠达成
术语错误代理系统智能体系统
括号错误大语言模型大语言模型（）
引号错误智能体系统智能体系统
