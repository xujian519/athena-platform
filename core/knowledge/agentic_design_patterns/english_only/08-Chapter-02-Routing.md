...
# Chapter 2: Routing | <mark></mark>

## Routing Pattern Overview | <mark></mark>
...
<mark><strong>LLM-based Routing</strong>。「、、」。。</mark>
...
<mark><strong>Embedding-based Routing</strong> 14 RAG。。「」「」。</mark>
...
<mark><strong>Rule-based Routing</strong>、 if-else 、switch 。。</mark>
...
<mark><strong>Machine Learning Model-Based Routing</strong>。。。。</mark>
...
<mark>LangChain、LangGraph Google ADK。LangGraph 。Google ADK 。。</mark>
...
<mark>。LangChain LangGraph 。LangGraph 。</mark>
...
<mark> OpenAI、Google Gemini、Anthropic API 。</mark>
...
[Colab ](https://colab.research.google.com/drive/1Yh3eUcvajJfgTFKhEQga6bJ3yyKodAmg) [](/codes/Chapter-02-Routing-LangChain-Example.py)。
...
<mark> Python LangChain Google gemini-2.5-flash 。booking_handler、info_handler unclear_handler。</mark>
...
<mark> coordinator_router_chain ChatPromptTemplate 'booker'、'info' 'unclear'。 RunnableBranch 。RunnableBranch booking_handler、info_handler unclear_handler。coordinator_agent 。</mark>
...
<mark> Python Google ADK 。「」「Booker」「Info」。。</mark>
...
[Colab ](https://colab.research.google.com/drive/10wxRlPyDJ70pPEtWWA3Aa3tjvfobrB3m) [](/codes/Chapter-02-Routing-ADK-Example.py)。
...
<mark>Booker Info。 FunctionTool Python 。booking_handler info_handler 。 unclear_handler run_coordinator 。</mark>
...
<mark> Booker Info 。ADK 。run_coordinator InMemoryRunner ID runner 。runner.run event.content 。</mark>
...
<mark> LangGraph Google ADK 。</mark>
...
<mark> LangChain Google ADK 。LangGraph 。Google ADK 。</mark>
...
<mark>LangGraph [https://www.langchain.com/](https://www.langchain.com/)</mark>

2. Google Agent Developer Kit Documentation: [https://google.github.io/adk-docs/](https://google.github.io/adk-docs/)

<mark>[https://google.github.io/adk-docs/](https://google.github.io/adk-docs/)</mark>
