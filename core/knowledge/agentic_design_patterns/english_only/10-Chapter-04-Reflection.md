...
# Chapter 4: Reflection | <mark></mark>

## Reflection Pattern Overview | <mark></mark>
...
<mark>Prompt Chaining、RoutingParallelization。、。、。<strong>Reflection</strong>。</mark>
...
<mark>ProducerCritic。「 - 」Generator-Critic「 - 」Producer-Reviewer。、。</mark>
...
<mark><strong></strong>。。。 LangChain ADK LangChain <code>reflector_prompt</code> ADK 。</mark>
...
<mark>。。 LangChain/LangGraph、ADK Crew.AI 。</mark>
...
<mark>。 LangGraph LCELLangChain 。</mark>
...
<mark> Langchain OpenAI <code>GPT-4o</code> Python 。。</mark>
...
<mark> OpenAI、Google Gemini、Anthropic <code>API</code> 。</mark>
...
[Colab ](https://colab.research.google.com/drive/1xnL6Rky6nsm4iAhomLnUK3kgwSyyYZfb) [](/codes/Chapter-04-Reflection-LangChain-Example.py)。
...
<mark>、 API GPT-4o 。 Python 、 0 、。</mark>

<mark><code>run_reflection_loop</code> 。。</mark>

<mark>「」。 <code>CODE_IS_PERFECT</code>。。</mark>
...
# 1. -> state['draft_text']。
# 2. -> state['draft_text'] state['review_output']。
```

[Colab ](https://colab.research.google.com/drive/1nwE2GH6c08dGlvAv7T28uF1xe2qeu2q_) [](/codes/Chapter-04-Reflection-ADK-Example.py)。
...
<mark> Google ADK 。 <code>LlmAgent</code> <code>generator</code> <code>reviewer</code>。 <code>draft_text</code>。 <code>draft_text</code> 。<code>status</code> <code>reasoning</code> <code>ACCURATE</code> <code>INACCURATE</code> <code>reasoning</code> <code>review_output</code>。</mark>

<mark> <code>review_pipeline</code> <code>SequentialAgent</code> 。。。<strong></strong> ADK <code>LoopAgent</code> 。</mark>
...
<mark> LangGraph LangChain LCEL 。</mark>
...
<mark>[https://arxiv.org/abs/2409.12917](https://arxiv.org/abs/2409.12917)</mark>
...
<mark>LangChain [https://python.langchain.com/docs/introduction/](https://python.langchain.com/docs/introduction/)</mark>

3. LangGraph Documentation:[https://www.langchain.com/langgraph](https://www.langchain.com/langgraph)

<mark>LangGraph [https://www.langchain.com/langgraph](https://www.langchain.com/langgraph)</mark>
