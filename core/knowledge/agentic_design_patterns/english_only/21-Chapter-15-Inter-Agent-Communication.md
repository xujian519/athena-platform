...
# Chapter 15: Inter-Agent Communication (A2A) | <mark> 15 : (A2A)</mark>
...
<mark> AI 、, , 。, (Inter-Agent Communication, A2A) AI 。、。Google A2A 。 A2A、 Google ADK 。</mark>

## Inter-Agent Communication Pattern Overview <mark></mark>
...
<mark>Agent2Agent (A2A) AI 。, LangGraph、CrewAI Google ADK AI , 。A2A , Atlassian、Box、LangChain、MongoDB、Salesforce、SAP ServiceNow。Microsoft A2A Azure AI Foundry Copilot Studio , 。, Auth0 SAP A2A 。, A2A , 。</mark>

## Core Concepts of A2A <mark>A2A </mark>
...
<mark>A2A , 。 A2A 。A2A 、、、、, 。</mark>

### Core Actors <mark></mark>
...
<mark>: (Agent Card) , JSON 。, 、 URL 。 ()、、/。 WeatherBot 。</mark>
...
<mark>Well-Known URI: (/.well-known/agent.json) 。。</mark>
...
<mark> (Direct Configuration): 。。</mark>
...
<mark>, 。、 TLS (mutual TLS, mTLS) , () 。</mark>

## Communications and Tasks | <mark></mark>
...
<mark> <code>attributes</code> <code>part</code>。<code>attributes</code> , 。<code>part</code> , 、 JSON 。 <code>artifacts</code>。, <code>artifacts</code> , 。A2A HTTP(S) , JSON-RPC 2.0 。, <code>contextId</code> 。</mark>

## Interaction Mechanisms | <mark></mark>
...
<mark>。, A2A (modality-agnostic) , , , AI 。。</mark>
...
<mark> <code>sendTask</code> , 、。, <code>sendTaskSubscribe</code> , 。</mark>
...
<mark>: ( OAuth 2.0 API ) , HTTP 。 URL , 。</mark>
...
<mark>A2A Anthropic (Model Context Protocol, MCP) ( 1)。MCP , A2A , 。</mark>
...
<mark>****: A2A AI , ( ADK、LangChain、CrewAI)。, , 。</mark>
...
## Hands-On Code Example | <mark></mark>
...
<mark> A2A 。 [https://github.com/google-a2a/a2a-samples/tree/main/samples](https://github.com/google-a2a/a2a-samples/tree/main/samples) Java、Go Python , ( LangGraph、CrewAI、 Azure AI Foundry AG2) A2A 。 Apache 2.0 。 A2A , , ADK Google A2A 。 [https://github.com/google-a2a/a2a-samples/blob/main/samples/python/agents/birthday_planner_adk/calendar_agent/adk_agent.py](https://github.com/google-a2a/a2a-samples/blob/main/samples/python/agents/birthday_planner_adk/calendar_agent/adk_agent.py)</mark>
...
<mark> Python <code>create_agent</code>, ADK <code>LlmAgent</code>。 <code>CalendarToolset</code> Google Calendar API。, <code>LlmAgent</code> , Gemini 、。 <code>CalendarToolset</code> , Calendar API , 。。</mark>
...
<mark>, GitHub A2A <code>calendar_agent</code> 。。, ; : [https://github.com/a2aproject/a2a-samples/blob/main/samples/python/agents/birthday_planner_adk/calendar_agent/__main__.py](https://github.com/a2aproject/a2a-samples/blob/main/samples/python/agents/birthday_planner_adk/calendar_agent/__main__.py)</mark>
...
<mark> Python A2A 「」, Google 。 API Vertex AI 。, <code>check_availability</code> , <code>AgentCard</code> , 。, ADK , 、。, Starlette Web , A2A , Uvicorn , HTTP 。</mark>
...
<mark> A2A , Web 。 ADK, Google AI 。 A2A 。</mark>
...
<mark> [https://www.trickle.so/blog/how-to-build-google-a2a-project](https://www.trickle.so/blog/how-to-build-google-a2a-project) A2A。 Python JavaScript A2A 、 Web 、。</mark>
...
<mark>: AI , ( Google ADK、LangGraph、CrewAI) , 。, , , 。, 。</mark>
...
<mark> (A2A) , AI 。 HTTP , ( Google ADK、LangGraph CrewAI) 。, , , 。, 、, 。, 。, mTLS 。 A2A MCP , 。。、。, A2A AI 。</mark>
