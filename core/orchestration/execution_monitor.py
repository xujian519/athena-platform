...
from core.orchestration.workflow_builder import WorkflowStep, WorkflowResult, ExecutionMode
from core.agents.xiaona.base_component import AgentStatus, AgentExecutionResult
...
async def execute_workflow(
    ...
    # 创建执行状态
    state = monitor.create_workflow_state(workflow_id)
