...
class EnhancedVectorSearchWithReranker:
    ...
    async def search(
        self, query: str, mode: Optional[SearchMode] = None, top_k: Optional[int] = None
    ...
    def _get_from_cache(self, cache_key: str) -> Optional[EnhancedSearchResult]:
        """从缓存获取"""
...
# 全局单例
_enhanced_searcher: Optional[EnhancedVectorSearchWithReranker] = None
