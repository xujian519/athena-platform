...
class SafeQueryExecutor:
    ...
    def execute_with_table_name(
        self, query_template: str, table_name: str, params: Optional[tuple] = None
    ) -> None:
        """
        使用动态表名安全执行查询
    ...
    def fetch_all_safe(
        self, query: str | Optional[Composable] = None, params: Optional[tuple] = None
    ) -> list[tuple]:
        """
        安全执行查询并获取所有结果
...
def safe_execute(
    cursor: PsycoCursor, query: str | Optional[Composable] = None, params: Optional[tuple] = None
) -> None:
    """
    安全执行查询的便捷函数
...
def safe_execute_with_table(
    cursor: Optional[PsycoCursor] = None, query_template: Optional[str] = None, table_name: Optional[str] = None, params: Optional[tuple] = None
) -> None:
    """
    使用动态表名安全执行查询的便捷函数
