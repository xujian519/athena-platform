...
from core.memory.timeline_memory_system import TimelineMemory
...
class PreferenceExtractor:
    ...
    def _extract_evaluative_preference(self, text: str, indicator: str) -> UserPreference | None:
        """提取评价性偏好"""
        # 查找被评价的对象
    ...
    def _extract_selective_preference(self, text: str, indicator: str) -> UserPreference | None:
        """提取选择性偏好"""
        # 简化实现
        return None
...
class DecisionPatternLearner:
    ...
    def predict_decision(self, scenario: str) -> DecisionPattern | None:
        """
        预测给定场景下的可能决策
