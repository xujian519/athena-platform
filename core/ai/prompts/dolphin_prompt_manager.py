...
class DolphinPromptManager:
    ...
    def get_prompt(
        self, prompt_type: PromptType, config: Optional[PromptConfig] = None, **kwargs
    ) -> str:
        """
        获取提示词
...
# 便捷函数
def get_prompt(prompt_type: Optional[PromptType] = None, config: Optional[PromptConfig] = None, **kwargs) -> str:
    """
    获取提示词的便捷函数
