...
warnings.warn(
    "unified_prompt_manager is deprecated and will be removed in v3.0. "
...
# 导入L1-L4系统
try:
    from core.framework.agents.prompts.xiaona_prompts import XiaonaPrompts
...
_manager_instance: Optional[UnifiedPromptManager] = None
...
async def load_agent_prompt(agent: Optional[str] = None, layers: Optional[Optional[list[str]] = None) -> str]:
    """便捷函数: 加载智能体提示词"""
