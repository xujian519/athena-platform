...
warnings.warn(
    "unified_prompt_manager_production is deprecated and will be removed in v3.0. "
...
from core.ai.prompts.integrated_prompt_generator import (
    IntegratedPromptGenerator,
    _sync_call_async,
)
...
class ProductionUnifiedPromptManager(UnifiedPromptManager):
    ...
    def _generate_default_prompt(
        ...
        default_system = _sync_call_async(self.load_prompt, "xiaona", PromptFormat.MARKDOWN)
