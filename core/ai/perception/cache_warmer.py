...
class CacheWarmer:
    ...
    def __init__(self, config: Optional[WarmupConfig] = None):
        ...
        # 预热任务
        self._warmup_task: asyncio.Optional[Task] = None
        self._background_task: asyncio.Optional[Task] = None
...
class CacheWarmerManager:
    ...
    async def warmup_all(
        self,
        cache_store: Optional[dict[str, Any],        progress_callback: Callable[..., Any] = None,
...
# 全局预热管理器实例
_global_warmer_manager: Optional[CacheWarmerManager] = None
