...
# 全局追踪器实例
_global_tracer: Optional[PerceptionTracer] = None


def get_tracer(config: Optional[TracingConfig] = None) -> PerceptionTracer:
    """获取全局追踪器实例
...
async def initialize_tracing(config: Optional[TracingConfig] = None) -> PerceptionTracer:
    """初始化全局追踪器
