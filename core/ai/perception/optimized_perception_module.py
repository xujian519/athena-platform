...
# 导入统一的类型定义
from core.ai.perception.types import CacheConfig
...
class IncrementalOCRProcessor:
    ...
    def __init__(self, config: dict[str, Any], cache_config: Optional[CacheConfig] = None):
        self.config = config
    ...
    def detect_document_changes(
        self, file_path: str, previous_metadata: Optional[DocumentMetadata] = None
    ) -> DocumentMetadata:
        """检测文档变更"""
        try:
