...
class LongTextProcessor:
    ...
    def __init__(self, model_loader: Optional[ModelLoader] = None, max_tokens: int = 8192):
        """初始化处理器
...
def create_long_text_processor(model_loader: Optional[ModelLoader] = None) -> LongTextProcessor:
    """创建长文本处理器的便捷函数
