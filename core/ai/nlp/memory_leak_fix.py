...
class GlobalMemoryMonitor:
    ...
    def __init__(self, config: MemoryConfig):
        ...
        self._running = False
        self._monitor_thread: threading.Optional[Thread] = None
...
class BGEEmbeddingServiceFixed:
    ...
    async def _check_cache(self, texts: list[str]) -> list[list[Optional[float]]]:
        """检查缓存(使用LRU缓存)"""
...
# 全局内存监控器实例
_global_memory_monitor: Optional[GlobalMemoryMonitor] = None
