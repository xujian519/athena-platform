...
create_cache: Optional[Callable[..., Any]] = None
LFUCache: Optional[Any] = None
HybridCache: Optional[Any] = None

try:
    from core.ai.nlp.lfu_cache import HybridCache, LFUCache, create_cache
...
# 全局优化器实例
_global_optimizer: Optional[NLPCacheOptimizer] = None
