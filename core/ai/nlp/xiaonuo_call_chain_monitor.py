...
class CallChainMonitor:
    ...
    def record_function_call(self, operation_name: str, tags: Optional[dict[str, str]] = None) -> Any:
        """记录函数调用的装饰器"""
...
# 便捷装饰器
def trace_operation(operation_name: Optional[str] = None, tags: Optional[dict[str, str]] = None) -> Any:
    """追踪操作的便捷装饰器"""
