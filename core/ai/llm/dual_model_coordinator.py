...
# 导入理科分类器和提示词
try:
    from core.ai.nlp.science_prompts import SciencePromptTemplates, ScienceTopic
except ImportError:
...
class DualModelCoordinator:
    ...
    async def _query_primary_model(
        ...
        try:
            from core.ai.llm.glm_client import get_glm_client
...
# 单例
_dual_model_coordinator: Optional[DualModelCoordinator] = None
