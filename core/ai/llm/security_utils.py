...
def mask_sensitive_data(data: Optional[str] = None, patterns: Optional[dict[str, str]] = None) -> str:
    """
    脱敏敏感数据
...
def safe_log_request(
    message: str, request_data: dict[str, Any], exclude_fields: Optional[list] = None
) -> str:
    """
    安全地记录请求数据(脱敏敏感信息)
