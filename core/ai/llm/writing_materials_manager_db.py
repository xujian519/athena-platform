...
class WritingMaterialsManagerDB:
    ...
    def __init__(self, rag_manager=None, materials_path: Optional[Path] = None):
        """
        初始化素材库管理器
...
def get_materials_manager_db(
    rag_manager=None, materials_path: Optional[Path] = None
...
if __name__ == "__main__":
    ...
    from core.ai.llm.rag_manager import get_rag_manager
