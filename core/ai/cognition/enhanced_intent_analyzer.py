...
class EnhancedIntent:
    ...
    # 法律世界模型集成
    domain: Domain                      # 业务领域
    task_type: Optional[TaskType] = None  # 任务类型
    phase: Optional[Phase] = None       # 业务阶段
    layer_type: Optional[LayerType] = None  # 相关层级

    # 专利特定信息
    patent_sub_domain: Optional[PatentSubDomain] = None  # 专利子领域
    patent_type: Optional[PatentType] = None            # 专利类型
...
class EnhancedIntentAnalyzer:
    ...
    def _recognize_patent_type(self, text: str) -> Optional[PatentType]:
        """识别专利类型"""
        text.lower()
    ...
    def _recognize_patent_sub_domain(self, text: str) -> Optional[PatentSubDomain]:
        """识别专利子领域"""
        text_lower = text.lower()
    ...
    def _calculate_confidence(
        ...
        patent_sub_domain: Optional[PatentSubDomain] = None,
    ) -> float:
        """计算综合置信度"""
