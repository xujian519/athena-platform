...
class IntegratedPatentResult:
    ...
    # 分析结果
    patent_analysis: Optional[PatentAnalysisResult] = None

    # 法律推理结果
    legal_reasoning: Optional[LegalAnalysisResult] = None

    # 撰写结果
    patent_draft: Optional[PatentDraftingResult] = None
