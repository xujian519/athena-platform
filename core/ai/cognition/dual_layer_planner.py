...
"""
    ...
    async def load_plan(self, task_id: str) -> Optional[TaskPlan]:
        """从 Markdown 文档加载计划"""
...
class TaskExecutionEngine:
    ...
    def __init__(self, plan_manager: Optional[MarkdownPlanManager] = None):
    ...
    async def load_and_resume_task(self, task_id: str) -> Optional[TaskPlan]:
        """加载并恢复任务"""
