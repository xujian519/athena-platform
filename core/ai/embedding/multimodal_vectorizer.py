...
from core.ai.embedding.nlp_service_adapter import NLPServiceAdapter, get_nlp_adapter
...
class MultimodalVectorizer:
    ...
    async def vectorize_file(
        self, file_path: str | Optional[Path] = None, file_id: Optional[str] = None
    ) -> VectorizationResult:
        """
        向量化单个文件
...
# 单例实例
_vectorizer_instance: Optional[MultimodalVectorizer] = None
