...
class DynamicPrompt:
    ...
    matched_scenario: Optional[ScenarioRule] = None
...
class LegalWorldPromptGenerator:
    ...
    def retrieve_scenario_rule(self, context: LegalContext) -> Optional[ScenarioRule]:
        """检索匹配的场景规则"""
        # 根据业务类型匹配场景
        task_type_mapping = {
...
- 标注信息来源和更新时间"""
    ...
    def generate_scenario_prompt(self, scenario: Optional[ScenarioRule]) -> str:
        """生成场景规则提示"""
        if not scenario:
            return "## 场景规则\n\n暂无匹配的场景规则。"
...
"""
    ...
    def calculate_confidence_score(
        ...
        scenario: Optional[ScenarioRule],
