...
try:
    ...
    from core.patent.licensing.patent_valuator import PatentValuator, ValuationResult
    from core.patent.licensing.clause_generator import ClauseGenerator, LicenseTerms
    from core.patent.licensing.agreement_writer import AgreementWriter
