...
try:
    ...
    from core.patent.international.pct_assistant import PCTAssistant, PCTApplication
    from core.patent.international.legal_adapter import LegalAdapter
    from core.patent.international.translation_assistant import TranslationAssistant
