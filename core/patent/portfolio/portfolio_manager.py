...
try:
    ...
    from core.patent.portfolio.patent_list_manager import PatentListManager, PatentRecord
    from core.patent.portfolio.patent_classifier import PatentClassifier, ClassificationResult, GradingResult
    from core.patent.portfolio.value_assessor import ValueAssessor, ValueAssessment
    from core.patent.portfolio.maintenance_decider import MaintenanceDecisionMaker, MaintenanceDecision
