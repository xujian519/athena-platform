...
from core.patent.qualitative_rules import get_qualitative_rule_engine
...
class SmartOfficeActionResponder:
    ...
    def __init__(self):
        ...
        try:
            from core.patent.dynamic_prompt_metrics import get_dynamic_prompt_metrics
    ...
    async def _generate_dynamic_prompt(
        ...
        if self.prompt_metrics:
            from core.patent.dynamic_prompt_metrics import PromptGenerationTimer
