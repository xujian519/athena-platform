...
try:
    ...
    from core.patent.infringement.claim_parser import ClaimParser, ParsedClaim
    from core.patent.infringement.product_analyzer import ProductAnalyzer, AnalyzedProduct
    from core.patent.infringement.feature_comparator import FeatureComparator, FeatureComparison
    from core.patent.infringement.infringement_determiner import InfringementDeterminer, InfringementResult
    from core.patent.infringement.opinion_writer import OpinionWriter
