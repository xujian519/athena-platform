...
try:
    ...
    # 绝对导入（直接运行时）
    from core.patent.drafting.disclosure_parser import DisclosureDocumentParser, DisclosureDocument
    from core.patent.drafting.technical_feature_extractor import TechnicalFeatureExtractor
    from core.patent.drafting.invention_understanding import InventionUnderstandingBuilder
    from core.patent.drafting.claim_generator import ClaimGenerator, ClaimGenerationOptions
    from core.patent.drafting.description_writer import DescriptionWriter
