...
# 导入各模块
try:
    from core.patent.oa_document_parser import OfficeActionParser, ParsedOfficeAction
    from core.patent.oa_human_interaction import (
        HumanInteractionWorkflow,
        InteractionStep,
        get_oa_interaction,
    )
    from core.patent.smart_oa_responder import (
        ResponsePlan,
