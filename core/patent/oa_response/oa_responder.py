...
try:
    from .prior_art_analyzer import PriorArtAnalyzer, PriorArtAnalysis
    ...
    from core.patent.oa_response.prior_art_analyzer import PriorArtAnalyzer, PriorArtAnalysis
    from core.patent.oa_response.response_strategy_generator import ResponseStrategyGenerator, ResponseStrategy
    from core.patent.oa_response.response_writer import ResponseWriter
