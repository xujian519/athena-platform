...
try:
    from core.patent.task_state_manager import PhaseStatus, TaskState, TaskStateManager, TaskStatus
...
"""
    ...
    def _get_scope_analyzer(self):
        ...
        if self._scope_analyzer is None:
            try:
                from core.patent.ai_services.claim_scope_analyzer import ClaimScopeAnalyzer
    ...
    def _get_drawing_analyzer(self):
        ...
        if self._drawing_analyzer is None:
            try:
                from core.patent.ai_services.drawing_analyzer import PatentDrawingAnalyzer
    ...
    async def _generate_claims(
        ...
        if claim_generator:
            try:
                from core.patent.claim_generator_v2 import SpecificationContext
    ...
    def _map_invention_type(self, inv_type: InventionType):
        """映射发明类型"""
        from core.patent.claim_generator_v2 import InventionType as ClaimInvType
        mapping = {
