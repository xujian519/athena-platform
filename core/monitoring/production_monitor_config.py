...
from core.monitoring.memory_monitor import MemoryMonitor, MemoryAlert, get_memory_monitor
...
class AlertManager:
    ...
    def __init__(
        ...
        notification_channels: Optional[List["key"] = None,
    ):
        """
        初始化告警管理器
...
class ProductionMemoryMonitor:
    ...
    def __init__(self, config: Dict[str | None = None, Any | None = None):
        """
        初始化生产环境监控
