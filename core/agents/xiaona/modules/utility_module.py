...
class UtilityModule:
    ...
    def _format_claims(self, content: str, config: Dict[str, Any]) -> str:
        """格式化权利要求书"""
        # 清理和规范化权利要求
    ...
    def _format_specification(self, content: str, config: Dict[str, Any],
    ...
    def _format_legal_document(self, content: str, config: Dict[str, Any],
                               doc_type: str) -> str:
        """格式化法律文书（答复/请求书）"""
    ...
    def _assess_standardization(self, content: str) -> float:
        """评估规范性"""
        score = 100.0
    ...
    def _adjust_score_by_review(self, metrics: QualityMetrics,
                                review_result: Dict[str, Any]) -> QualityMetrics:
        """根据审查结果调整评分"""
    ...
    def compare_versions(self, version1: str, version2: str) -> DiffResult:
        """
        对比两个版本的文档
