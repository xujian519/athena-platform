...
class BaseAgent(ABC):
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        # 工具管理器(延迟初始化)
        self._tool_registry: UnifiedToolRegistry | None = None
    ...
    async def _get_tool_registry(self) -> UnifiedToolRegistry | None:
        """
        获取工具注册中心(延迟初始化)
...
class AgentRegistry:
    ...
    @classmethod
    def _get_instance(cls) -> _AgentRegistryInstance:
        """获取单例实例"""
