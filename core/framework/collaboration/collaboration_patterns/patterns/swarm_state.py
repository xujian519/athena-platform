...
class SwarmSharedState:
    ...
    def get_member_state(self, agent_id: str) -> Optional[AgentState]:
        """
        获取成员状态
    ...
    def get_knowledge(self, key: str) -> Optional[SwarmKnowledgeItem]:
        """
        获取知识
    ...
    def get_role_distribution(self) -> dict[SwarmRole, int]:
        ...
        Returns:
            角色到数量的映射
        """
        distribution = dict.fromkeys(SwarmRole, 0)
