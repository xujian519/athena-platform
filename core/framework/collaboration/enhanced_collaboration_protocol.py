...
# Gateway客户端可选导入
try:
    from core.framework.agents.gateway_client import AgentType as GatewayAgentType
    from core.framework.agents.gateway_client import GatewayClient, GatewayClientConfig
    from core.framework.agents.gateway_client import Message as GatewayMessage
    from core.framework.agents.gateway_client import MessageType as GatewayMessageType
...
class EnhancedCollaborationProtocol:
    ...
    async def process_message(self, message: Message) -> Optional[Any]:
        """处理消息"""
...
# 导出便捷函数
_collaboration_protocol: Optional[EnhancedCollaborationProtocol] = None
