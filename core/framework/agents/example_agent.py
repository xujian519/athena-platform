...
class ExampleAgent(BaseAgent):
    ...
    async def _handle_echo(self, params: Optional[dict[str, Any]])] -> dict[str, Any]:
        """处理echo请求"""
    ...
    async def _handle_add(self, params: Optional[dict[str, Any])] -> dict[str, Any]:
        """处理add请求"""
        a = params.get("a", 0)
        b = params.get("b", 0)
        return {
    ...
    async def _handle_get_stats(self, params: Optional[dict[str, Any])] -> dict[str, Any]:
        """处理get-stats请求"""
    ...
    async def _handle_get_capabilities(self, params: Optional[dict[str, Any])] -> dict[str, Any]:
