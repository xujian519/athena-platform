...
class AgentLoader:
    ...
    def __init__(self, project_root: str | Path  = None):
        ...
        self._agents: Optional[dict[str, AgentDefinition] = {}]
    ...
    def _load_file(self, file_path: Path, source: AgentSource) -> AgentDefinition :
        """
        加载单个 .md 文件
...
def get_agent(name: str, project_root: Optional[str] = None) -> AgentDefinition :
    """获取指定名称的 Agent 定义"""
