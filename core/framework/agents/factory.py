...
from core.framework.agents.base import AgentRegistry, BaseAgent
...
class AgentFactory:
    ...
    # 类级别的智能体类注册表
    _agent_classes: Optional[dict[str, type[BaseAgent]]] = {}

    @classmethod
    def register_agent_class(cls, agent_class: Optional[type[BaseAgent]]) -> str:
        """
        注册智能体类
    ...
    @classmethod
    def unregister_agent_class(cls, name: str) -> str:
        """
        注销智能体类
    ...
    @classmethod
    def is_registered(cls, name: str) -> str:
        """
        检查智能体类是否已注册
    ...
    def load_declarative_agents(cls, project_root: Optional[str] = None) -> list[str]:
        ...
        """
        try:
            from core.framework.agents.declarative import DeclarativeAgent, load_all_agents
        except ImportError:
...
class AgentAutoLoader:
    ...
    def __init__(self, base_path: Optional[str] = None):
        ...
        self.loaded_agents: Optional[list[str]] = []
        self.failed_loads: Optional[dict[str, str]] = {}
...
async def create_agent_from_config(config: Optional[dict[str, Any]]) -> str:
    """
    从配置字典创建智能体
