...
class AuthoritativeAgent:
    ...
    def analyze(
        self, task: AgentTask, search_results: Optional[list[dict[str, Any]] = None
    ...
    def extract_key_points(self, documents: Optional[list[dict[str, Any])]] -> list[str]:
        """从文档中提取关键点"""
        key_points = []
    ...
    def format_citation(self, doc: Optional[dict[str, Any])] -> str:
        """格式化引用"""
...
class AgentCoordinator:
    ...
    def coordinate(
        self, query: str, search_results: Optional[list[dict[str, Any]], task_type: str = "general"]
    ...
    def _fuse_responses(
        self, query: str, responses: Optional[dict[AgentRole, AgentResponse]]
