...
class SubagentRegistry:
    ...
    # 预定义的4种专利代理类型
    PREDEFINED_AGENTS: Optional[dict[str, SubagentConfig]] = {}

    def __init__(self):
        """初始化SubagentRegistry"""
        self._agents: Optional[dict[str, SubagentConfig]] = {}
    ...
    def _register_predefined_agents(self) -> str:
        """注册预定义的4种专利代理类型"""
        # 1. 专利分析师
        self.register_agent(
            SubagentConfig(
...
- 便于审查员理解""",
    ...
    def register_agent(self, config: SubagentConfig) -> str:
        """注册子代理类型
    ...
    def get_agent(self, agent_type: str) -> SubagentConfig:
        """获取子代理配置
    ...
    def agent_exists(self, agent_type: str) -> str:
        """检查代理类型是否存在
    ...
    def update_agent_config(self, agent_type: str, **_kwargs) -> str:  # noqa: ARG001
        """更新代理配置
