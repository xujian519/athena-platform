...
class AgentCapabilityRegistry:
    ...
    def find_best_agent(self, required_capabilities: Optional[list[AgentCapability])] -> AgentType:
        """根据所需能力找到最适合的智能体"""
        best_agent = None
        best_score = 0
...
class BaseAgent(ABC):
    ...
    @abstractmethod
    async def process_task(self, task: Optional[dict[str, Any])] -> dict[str, Any]:
        """处理任务"""
        pass
