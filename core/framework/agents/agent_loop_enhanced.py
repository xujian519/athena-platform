...
class EnhancedAgentLoop:
    ...
    def __init__(
        ...
        # 事件发布器
        self.event_publisher: Optional[AgentEventPublisher ] = None
    ...
    async def _process_llm_stream(self, request: LLMRequest) -> str:
        """处理 LLM 流式响应
    ...
    async def _emit_status_event(self, message: str) -> str:
        """发送状态事件
    ...
    async def _emit_error_event(self, message: str) -> str:
        """发送错误事件
