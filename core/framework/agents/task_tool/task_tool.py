...
class TaskTool:
    ...
    def to_tool_definition(self) -> str:
        """
    ...
    def execute(
        ...
        fork_context: Optional[dict[str, Any]],]
    ...
    def _validate_input(self, prompt: str, tools: Optional[list[str)]] -> str:
        """验证输入
    ...
    async def _execute_sync_async(self, task_record: TaskRecord) -> dict[str, Any]:
        ...
        return {
            ...
            "filtered_tools": Optional[task_record.input.tools if task_record.input else [],]
