...
from core.framework.memory.embedding_store import EmbeddingStore
from core.framework.memory.unified_memory_system import MemoryCategory, MemoryEntry, MemoryType
...
async def get_vector_search_service(
    ...
    if embedding_store is None:
        from core.framework.memory.embedding_store import get_embedding_store
