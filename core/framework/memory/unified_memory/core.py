...
from core.framework.memory.unified_memory.utils import (
    retry_with_backoff,
)
...
class UnifiedAgentMemorySystem:
    ...
    def __init__(self):
        ...
        # 连接池 - 添加类型注解
        self.pg_pool: asyncpg.Optional[Pool] = None
        self.qdrant_client: aiohttp.Optional[ClientSession] = None
        self.kg_client: aiohttp.Optional[ClientSession] = None
        self.redis_client: aioredis.Optional[Redis] = None
    ...
    async def _get_memory_by_id(self, memory_id: str) -> Optional[dict]:
        """
        根据ID获取记忆
