...
旧导入:
  from core.framework.memory.optimized_memory_system import OptimizedMemorySystem

新导入:
  from core.framework.memory.optimized_memory import OptimizedMemorySystem
  # 或
  from core.framework.memory.optimized_memory.core import OptimizedMemorySystem
...
# 推荐导入方式
from core.framework.memory.optimized_memory import (
...
# 向后兼容重定向
from core.framework.memory.optimized_memory import (  # type: ignore
    ColdTierManager,
    DataAccessPattern,
    HotTierManager,
    IntelligentTierManager,
