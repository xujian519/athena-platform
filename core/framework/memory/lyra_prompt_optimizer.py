...
"""
    ...
    def _init_llm_service(self):
        ...
        if self.use_lyra_llm:
            try:
                from core.framework.memory.lyra_llm_service import LLMRequest as LyraLLMRequest
                from core.framework.memory.lyra_llm_service import get_lyra_llm_service
