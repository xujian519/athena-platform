...
class SupervisorOrchestrator:
    ...
    async def orchestrate_task(self, user_request: str, context: Optional[dict] = None) -> dict[str, Any]:
        """
...
async def orchestrate_task(user_request: str, context: Optional[dict] = None) -> dict[str, Any]:
    """便捷函数: 编排任务"""
