...
class NumpyCompatibilityManager:
    ...
    def get_safe_array(self, data: Any, dtype: Optional[Union[str, type]] = None) -> "np.ndarray":
        """创建安全的numpy数组"""
        import numpy as np
    ...
    def safe_random(self, size: Union[int, tuple], dtype: Optional[type] = None) -> "np.ndarray":
        """安全的随机数生成"""
        import numpy as np
