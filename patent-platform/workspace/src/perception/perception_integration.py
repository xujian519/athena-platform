...
from models.novelty_analyzer import NoveltyAnalyzer, TechnicalFeature
...
class UnifiedPatentPerceptionLayer:
    ...
    def _merge_results(self, patent_id: str, enhanced_result: Optional[Dict], core_result: Optional[Dict]) -> Dict[str, Any]:
        """合并两个引擎的结果"""
        merged_result = {
            'patent_id': patent_id,
            'unified_features': [],
