...
class ProductionPatentSearchInput(BaseModel):
    ...
    assignee: str | None = Field(None, description='专利权人/受让人过滤')
    inventor: str | None = Field(None, description='发明人过滤')
    ...
    date_range: str | None = Field(None, description='日期范围，格式: YYYY-YYYY 或 YYYY-MM-DD:YYYY-MM-DD')
