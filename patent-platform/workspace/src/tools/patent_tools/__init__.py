...
# 导入核心专利工具类
try:
    from patent_platform.workspace.src.patent_tools.patent_invalidator import (
        PatentInvalidator,
    )
...
try:
    from patent_platform.workspace.src.patent_tools.invalidity_predictor import (
        InvalidityPredictor,
    )
...
try:
    from patent_platform.workspace.src.patent_tools.legal_knowledge_enhancer import (
