...
def main():
    ...
    try:
        ...
        if import_stats['success']:
            ...
            logger.info("   2. 查询精英实体: MATCH (e:Entity {quality_layer: 'elite'}) RETURN e")
            logger.info("   3. 分析关系网络: MATCH (e1)-[r]->(e2) RETURN e1.type, r.type, e2.type LIMIT 10")
            logger.info("   4. 查看质量分布: MATCH (e) RETURN e.quality_layer, count(e)")
