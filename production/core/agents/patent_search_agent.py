...
# 导入专利检索模块
try:
    from patent_hybrid_retrieval.hybrid_retrieval_system import (
...
class PatentSearchAgent(BaseAgent):
    ...
    async def _handle_analyze_requirement(self, params: dict[str, Any]) -> dict[str, Any]:
        """分析检索需求"""
    ...
    async def _handle_search_cn(self, params: dict[str, Any]) -> dict[str, Any]:
        """检索中文专利"""
        keywords = params.get("keywords", [])
        limit = params.get("limit", 50)

        if not keywords:
            return {"results": [], "count": 0, "source": "CNIPA"}
    ...
    async def _handle_search_foreign(self, params: dict[str, Any]) -> dict[str, Any]:
        """检索国外专利"""
        params.get("keywords", [])
        params.get("limit", 50)
    ...
    async def _handle_search_families(self, params: dict[str, Any]) -> dict[str, Any]:
        """检索专利家族"""
    ...
    async def _handle_merge_results(self, params: dict[str, Any]) -> dict[str, Any]:
        """合并检索结果"""
