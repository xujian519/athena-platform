...
from core.patent.ipc_vector_database import IPCClassificationResult, get_ipc_vector_db
from core.patent.negentropy_retrieval import get_negentropy_retrieval_system
