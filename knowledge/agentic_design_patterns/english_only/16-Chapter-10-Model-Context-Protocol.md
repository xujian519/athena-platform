...
# Chapter 10: Model Context Protocol | <mark> 10 </mark>
...
<mark>LLM。、、。Model Context ProtocolMCP LLM 、。</mark>

------

## MCP Pattern Overview | <mark>MCP </mark>
...
<mark>LLM、 MCP 。MCP Gemini、OpenAI GPT、Mixtral Claude 、、。、、。</mark>
...
<mark>MCP 「 - 」。 MCP 、、。MCP LLM AI 。 LLM 。</mark>
...
<mark>MCP API API 。 API MCP 。</mark>

<mark> MCP PDF PDF 。 Markdown API。 MCP 。</mark>

------

## MCP vs. Tool Function Calling | <mark>MCP </mark>
...
<mark>MCP 、。 LLM 、 LLM 。、、。</mark>

<mark>MCP 。 MCP AI 。 LLM 。。</mark>
...
| <mark></mark> | <mark></mark> | <mark>MCP</mark> |
| :---------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| <mark></mark> | <mark> LLM 。</mark> | <mark> LLM 。</mark> |
| <mark></mark> | <mark>LLM 。</mark> | <mark> LLM 。</mark> |
| <mark></mark> | <mark>LLM 。</mark> | <mark>「 - 」 LLM MCP 。</mark> |
| <mark></mark> | <mark>。</mark> | <mark>。</mark> |
| <mark></mark> | <mark> LLM 。</mark> | <mark> MCP 。</mark> |
...
## Additional considerations for MCP | <mark>MCP </mark>
...
<mark><strong> vs. vs. </strong>。 PDF API LLM 。</mark>
...
<mark><strong></strong> MCP 。 Anthropic FastMCP SDK MCP 。</mark>
...
<mark><strong> vs. </strong>MCP 。、。</mark>
...
<mark><strong></strong>。 JSON-RPC /。 Streamable HTTP SSE Web 、「 - 」。</mark>
...
<mark><strong>MCP </strong> LLM LLM MCP 。 MCP 、。</mark>
...
<mark><strong>MCP </strong> MCP 、。、 API 。</mark>
...
<mark><strong></strong> MCP 、。、 SaaS API 。</mark>
...
<mark><strong></strong>MCP LLM MCP 。 <code>send_email</code>、 <code>customer_database</code>。</mark>
...
<mark><strong></strong> LLM 。<code>send_email</code>、、。</mark>
...
<mark><strong></strong>MCP LLM MCP 。</mark>
...
<mark><strong></strong>MCP API <code>send()</code> 。</mark>
...
<mark><strong></strong>MCP MCP 。。 LLM。</mark>
...
<mark><strong></strong> MCPLLM 。 MCP Google BigQuery 、。</mark>
...
<mark><strong></strong>MCP 。 MCP Google Imagen 、 Google Veo 、 Google Chirp 3 HD 、 Google Lyria AI 。</mark>
...
<mark><strong> API </strong>MCP LLM API 。、、 CRM 。</mark>
...
<mark><strong></strong> LLM MCP 。、。</mark>
...
<mark><strong></strong> MCP FastMCP。、 LLM LLM 。</mark>
...
<mark><strong></strong>MCP LLM LLM 。</mark>
...
<mark><strong></strong> MCP 。 MCP 。</mark>
...
<mark><strong></strong>MCP LLM 、。、、。</mark>
...
<mark>MCP 、API 、、、。MCP AI 。</mark>

------

## Hands-On Code Example with ADK | <mark> Google ADK</mark>
...
### Agent Setup with MCPToolset | <mark> MCPToolset</mark>
...
<mark> <code>agent.py</code> <code>./adk_agent_samples/mcp_agent/agent.py</code> 。<code>MCPToolset</code> <code>LlmAgent</code> <code>tools</code> 。 <code>args</code> <code>"/path/to/your/folder"</code> MCP 。。</mark>
...
<mark><code>npx</code>Node Package Execute npm 5.2.0 npm registry Node.js 。 npm Node.js MCP 。</mark>
...
<mark>ADK <code>agent.py</code> Python <code>__init__.py</code> 。 <code>agent.py</code> 。</mark>
...
<mark> Python UVX uv Python 。 Python MCP 。</mark>
...
### Connecting the MCP Server with ADK Web | <mark> ADK Web MCP </mark>

To begin, execute 'adk web'. Navigate to the parent directory of mcp_agent (e.g., adk_agent_samples) in your terminal and run:

<mark>「adk web」。 <code>mcp_agent</code> <code>adk_agent_samples</code></mark>
...
<mark> ADK Web <code>filesystem_assistant_agent</code>。</mark>
...
## Creating an MCP Server with FastMCP | <mark> FastMCP MCP </mark>
...
<mark>FastMCP 。 AI 。FastMCP 、、 AI 。</mark>

### Server setup with FastMCP | <mark> FastMCP </mark>
...
<mark> Python <code>greet</code> 。 <code>@tool()</code> AI 。FastMCP 、。</mark>
...
<mark> FastMCP localhost:8000 。 <code>greet</code> 。。。</mark>

### Consuming the FastMCP Server with an ADK Agent | <mark> ADK FastMCP </mark>
...
<mark> ADK MCP FastMCP 。 FastMCP <code>http://localhost:8000</code> <code>HttpServerParameters</code>。</mark>
...
<mark> <code>tool_filter</code> <code>greet</code> 。「 John Doe」 MCP <code>greet</code> 「John Doe」。 MCP ADK 。</mark>
...
<mark> <code>./adk_agent_samples/fastmcp_client_agent/</code> <code>agent.py</code>。 ADK <code>HttpServerParameters</code> FastMCP 。</mark>
...
<mark> <code>fastmcp_greeter_agent</code> Gemini 。。—— <code>MCPToolset</code> <code>localhost:8000</code> FastMCP 。 <code>greet</code> 。。</mark>
...
<mark> <code>fastmcp_client_agent</code> <code>__init__.py</code> ADK Python 。</mark>
...
<mark> <code>python fastmcp_server.py</code> FastMCP 。 <code>fastmcp_client_agent</code> <code>adk_agent_samples</code> <code>adk web</code> 。 ADK Web <code>fastmcp_greeter_agent</code>。「 John Doe」 FastMCP <code>greet</code> 。</mark>
...
<mark><strong></strong>、、、API MCP 。MCP 。。</mark>
...
<mark> MCP Google Cloud Imagen、Veo、Chirp 3 HD Lyria。</mark>
...
<mark>MCP。「 - 」 LLM 、。MCP LLM 、、。 MCP FastMCP ADK。MCP AI 。</mark>
...
<mark>1. MCP。[https://google.github.io/adk-docs/mcp/](https://google.github.io/adk-docs/mcp/)</mark>

2. FastMCP Documentation. FastMCP. [https://github.com/jlowin/fastmcp](https://github.com/jlowin/fastmcp)

<mark>2. FastMCP 。[https://github.com/jlowin/fastmcp](https://github.com/jlowin/fastmcp)</mark>
...
<mark>3. MCP 。[https://google.github.io/adk-docs/mcp/#mcp-servers-for-google-cloud-genmedia](https://google.github.io/adk-docs/mcp/#mcp-servers-for-google-cloud-genmedia)</mark>
...
<mark>4. MCP 。[https://google.github.io/adk-docs/mcp/databases/](https://google.github.io/adk-docs/mcp/databases/)</mark>