...
# Chapter 16: Resource-Aware Optimization | <mark> 16 </mark>
...
<mark>* <strong> LLM </strong>、 LLM 、 LLM 。</mark>
...
<mark>。 <code>Gemini Flash</code>。 <code>Gemini Pro</code>。。。</mark>
...
<mark>。、 LLM <code>Gemini Pro</code>。「」。</mark>
...
<mark>、、。「」、 <code>Gemini Flash</code>。。</mark>
...
<mark>Google <code>ADK</code> 。。 Gemini <code>Gemini Pro</code> <code>Gemini Flash</code> <code>LiteLLM</code> 。ADK 、 LLM 。。</mark>
...
<mark><code>GeminiProAgent</code> <code>Gemini Pro 2.5</code> <code>GeminiFlashAgent</code> <code>Gemini Flash 2.5</code> 。</mark>

### Router Agent | <mark></mark>
...
<mark>。 LLM ML 。 LLM 。 Flash Pro 。</mark>
...
<mark> <code>QueryRouterAgent</code> LLM 。。 20 <code>Gemini Flash Agent</code> <code>Gemini Pro Agent</code>。</mark>

### Critique Agent | <mark></mark>
...
<mark> <code>CRITIC_SYSTEM_PROMPT</code>。、、、。</mark>
...
## Hands-On Code with OpenAI | <mark> OpenAI </mark>
...
<mark>* <strong>simple</strong>。</mark>
...
<mark>* <strong>reasoning</strong>。</mark>
...
<mark>* <strong>internet_search</strong> Google 。</mark>
...
<mark> MIT GitHub (https://github.com/mahtabsyed/21-Agentic-Patterns/blob/main/16_Resource_Aware_Opt_LLM_Reflection_v2.ipynb)</mark>
...
<mark> Python 。 <code>.env</code> OpenAI Google Custom Search API 。<code>simple</code>、<code>reasoning</code> <code>internet_search</code>。 <code>classify_prompt</code> OpenAI 。 Google Custom Search API Google 。 <code>generate_response</code> OpenAI 。。 <code>handle_prompt</code> 。、。。</mark>

---

## Hands-On Code Example (OpenRouter) | <mark> OpenRouter </mark>
...
<mark>OpenRouter API AI 。 SDK 。</mark>
...
<mark> <code>requests</code> OpenRouter API 。 POST 。 API 。 <code>openai/gpt-4o</code>。</mark>
...
<mark>OpenRouter https://openrouter.ai/rankings AI 。ChatGPT、Gemini、Claude 1。</mark>

![OpenRouter Web site](/images/chapter16_fig1.png)

<mark><strong> 1</strong>OpenRouter (https://openrouter.ai/)</mark>

---

## Beyond Dynamic Model Switching: A Spectrum of Agent Resource Optimizations | <mark></mark>
...
<mark><strong></strong> API 、。 API 。</mark>
...
<mark>* <strong></strong>Google ADK 。、、。</mark>
...
<mark>* <strong>、 LLM </strong> Gemini Flash Gemini Pro。。</mark>
...
1. <mark>Google ADK[google.github.io/adk-docs](https://google.github.io/adk-docs/)</mark>
2. <mark>Gemini Flash 2.5 Gemini 2.5 Pro[aistudio.google.com](https://aistudio.google.com/)</mark>
