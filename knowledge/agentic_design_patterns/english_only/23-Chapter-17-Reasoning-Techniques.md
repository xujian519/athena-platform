...
# Chapter 17: Reasoning Techniques | <mark> 17 </mark>
...
<mark>** (CoT)** 1LLM。CoT 。 LLM 、。、。</mark>

<mark>CoT LLM 。。CoT “”。、。 LLM 。</mark>

<mark>Autonomous Agents、。</mark>
...
<mark> CoT 。"Agent's Thought Process"""。"Agent's Final Answer"、。</mark>
...
3. **Simulate Information Retrieval - /** 。。
...
<mark>**ToT** Chain-of-Thought, CoT。 2。、。。。</mark>
...
<mark>**Self-correction**self-refinement。。、。、。 4 。</mark>
...
<mark> AI 。、。 AI “”Self-Correction Agent。“”Initial Draft。“”Self-Correction Agent's Thought Process。。。“”Final Revised Content、。</mark>
...
“。。 GreenTech Gadgets ”
1“🌱 GreenTech Gadgets 。 #EcoFriendly #GreenTech”148
。

🌱 GreenTech Gadgets 。 #EcoFriendly #GreenTech
```
...
<mark>**Program-Aided Language Models, PALMs** LLM。 LLM Python。PALMs 、。 LLM 。、。 LLM 。、。 Google ADK 。</mark>
...
<mark>**Reinforcement Learning with Verifiable Rewards, RLVR** LLM Chain-of-Thought, CoT。、。**「」。「」。「」、** Token。。RLVR。。。「」、。 AI 。</mark>
...
<mark>**ReAct** 3 KB CoT。ReAct 。 CoT 、。、 API 。</mark>
...
<mark>**CoD**Chain of Debates AI 、 AI 「」。 AI 、。、。 AI 。、。</mark>
...
<mark>GoDGraph of DebatesAgentic、。「」「」。、。。「」。ground truth。search grounding。。。、 AI 、。</mark>
...
<mark>**MASS** Multi-Agent Systems, MASPrompt。。**MASS** MAS 。</mark>
...
<mark>**1. Block-Level Prompt Optimization** 「」。。 HotpotQA 「」**「」。。**。</mark>
...
<mark>**2. Workflow Topology Optimization** MASS 。MASS 。「」。 MBPP 。。。 MAS 。</mark>
...
<mark> 4Multi-Agent System Search, MASS、、、。。。。</mark>
...
<mark>** 3. Workflow-Level Prompt Optimization** 。、。 DROP **「」"Predictor" agent。****「」"extractive question answering"「」"numerical information"。**few-shot examples「 AI。」。、。</mark>
...
<mark>LLM Scaling Inference Law for LLMs。。Deep ResearchAI Web 。</mark>
...
<mark>** Deep Research。** 「」Agentic AI 、。 Perplexity AI、Google Gemini OpenAI ChatGPT 5。</mark>
...
<mark> 5 Google Deep Research</mark>
...
<mark>Google DeepSearch gemini-fullstack-langgraph-quickstart 6。 Gemini 2.5 LangGraph AI 。 Gemma LLM 。 Docker 。。</mark>
...
<mark>
React LangGraph AI 。LangGraph Google Gemini Google Search API 。。。 frontend/ backend/ 。 Node.js、npm、Python 3.8+ Google Gemini API 。 .env API pip install .npm install。 make dev 。 backend/src/agent/graph.py Gemini 。 Redis Postgres 。 docker-compose up Docker LangSmith API docker-compose.yml 。 Vite、Tailwind CSS、Shadcn UI、LangGraph Google Gemini React。 Apache License 2.0 。
</mark>
...
LLM 。ReAct few-shot learning LLM 。。
...
<mark>● Scaling Inference Law“”、。</mark>
...
<mark>● Chain-of-Thought, CoT。</mark>
...
<mark>● Tree-of-ThoughtSelf-Correction、。</mark>
...
<mark>● Chain of Debates, CoD。</mark>
...
<mark>1. Wei 2022《Chain-of-Thought Prompting Elicits Reasoning in Large Language Models》</mark>

2. "Tree of Thoughts: Deliberate Problem Solving with Large Language Models" by Yao et al. (2023)
<mark>2. Yao 2023《Tree of Thoughts: Deliberate Problem Solving with Large Language Models》</mark>

3. "Program-Aided Language Models" by Gao et al. (2023)
<mark>3. Gao 2023《Program-Aided Language Models》</mark>

4. "ReAct: Synergizing Reasoning and Acting in Language Models" by Yao et al. (2023)
<mark>4. Yao 2023《ReAct: Synergizing Reasoning and Acting in Language Models》</mark>
