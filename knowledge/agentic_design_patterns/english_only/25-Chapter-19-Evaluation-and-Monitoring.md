...
# Chapter 19: Evaluation and Monitoring | <mark> 19 </mark>
...
<mark>Python <code>evaluate_response_accuracy</code> AI 。 1.0 0.0。。</mark>
...
<mark>。NLP。 AI 。 Levenshtein Jaccard 、、、LLM LLM-as-a-Judge RAG 。</mark>
...
<mark>**** AI 。。。。。 JSON、 InfluxDB、Prometheus、 Snowflake、BigQuery、PostgreSQL Datadog、Splunk、Grafana Cloud。</mark>
...
<mark>** LLM Token ** LLM token 。LLM token 。 token 。 token 。</mark>
...
<mark> Python <code>LLMInteractionMonitor</code> token 。 token 。 <code>record_interaction</code> token 。 LLM API token 。 token 。<code>get_total_tokens</code> LLM 。</mark>
...
<mark><strong> LLM 「」</strong> AI 「」。 LLM 。 LLM LLM-as-a-Judge「」 AI 。 LLM 、。。</mark>
...
<mark> Python LLMJudgeForLegalSurvey AI 。 google.generativeai Gemini 。</mark>
...
<mark>judge_survey_question Gemini JSON 。 JSON 、、、。 AI JSON 。 AI 。</mark>
...
| --- | --- | --- |
| <mark></mark> | <mark></mark> | <mark>、。</mark> |
| <mark>LLM </mark> | <mark>、</mark> | <mark> LLM 。</mark> |
| <mark></mark> | <mark>、</mark> | <mark>。</mark> |

---

## Agents trajectories | <mark></mark>
...
<mark>AI evalset。 JSON 、-。-、、。「Turn off device_2 in the Bedroom」 <code>set_device_info</code> <code>location: Bedroom</code>、<code>device_id: device_2</code> <code>status: OFF</code>「I have set the device_2 status to off」。 <code>test_config.json</code> 。 <code>evalset</code> 。 <code>evals</code>、、。「What can you do?」「Roll a 10 sided dice twice and then check if 9 is a prime or not」 <code>roll_die</code> <code>check_prime</code> 。</mark>
...
## From Agents to Advanced Contractors | <mark></mark>
...
<mark>Agent CompanionGulli AI 「」、、 2。</mark>
...
<mark>Formalized Contract。。「」「 20 PDF 2025 、 2024 」。、、、。</mark>
...
<mark>Dynamic Lifecycle of Negotiation and Feedback。。。「 XYZ 。。」。</mark>
...
<mark>Quality-Focused Iterative Execution。。。、。、。</mark>
...
<mark>Hierarchical Decomposition via Subcontracts。、。、「」。「」「 UI/UX」、「」、「」「」。、。、 AI 。</mark>
...
<mark> Web UI 。Pytest <code>AgentEvaluator.evaluate</code> 。</mark>
...
<mark><strong></strong>Agentic systems LLM 、。。。、、。、。</mark>
...
<mark><strong></strong>。、 LLM token 。 LLM 。、A/B 。</mark>
