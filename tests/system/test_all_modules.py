...
def test_cap01_patent_search():
    ...
    try:
        ...
        from core.patent.comprehensive_analyzer import ComprehensivePatentAnalyzer
...
def test_cap02_patent_evaluation():
    """测试CAP02: 专利评估系统"""
    try:
        from core.patent.quality_assessor import (
            QualityAssessment,
            QualityDimension,
            SeverityLevel,
            QualityIssue,
...
def test_cap03_patent_drafting():
    """测试CAP03: 专利撰写辅助系统"""
    try:
        from core.patent.drafting.patent_drafter import PatentDrafter
...
def test_cap04_oa_response():
    """测试CAP04: 审查意见答复系统"""
    try:
        from core.patent.oa_response.oa_responder import OAResponder
...
def test_cap05_invalidity():
    """测试CAP05: 无效宣告请求系统"""
    try:
        from core.patent.invalidity.invalidity_petitioner import InvalidityPetitioner
...
def test_cap06_infringement():
    """测试CAP06: 侵权分析系统"""
    try:
        from core.patent.infringement.infringement_analyzer import InfringementAnalyzer
...
def test_cap07_licensing():
    """测试CAP07: 许可协议起草系统"""
    try:
        from core.patent.licensing.licensing_drafting import LicensingDrafting
...
def test_cap08_litigation():
    """测试CAP08: 专利诉讼支持系统"""
    try:
        from core.patent.litigation.litigation_supporter import LitigationSupporter
...
def test_cap09_portfolio():
    """测试CAP09: 专利组合管理系统"""
    try:
        from core.patent.portfolio.portfolio_manager import PortfolioManager
...
def test_cap10_international():
    """测试CAP10: 国际专利申请系统"""
    try:
        from core.patent.international.international_filing_manager import InternationalFilingManager
