...
def search(
    ...
    output: str | None = typer.Option("./results", "--output", "-o", help="输出目录"),
):
    """
    批量检索 ⭐⭐⭐⭐⭐
...
def analyze(
    ...
    output: str | None = typer.Option("./reports", "--output", "-o", help="输出目录"),
):
    """
    批量分析 ⭐⭐⭐⭐⭐（核心价值）
    ...
    console.print("[bold yellow]⭐ 核心价值功能 - 验证CLI独特优势[/bold yellow]\n")
