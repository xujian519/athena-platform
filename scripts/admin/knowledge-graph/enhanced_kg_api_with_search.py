    ...
    def setup_routes(self):
        ...
        async def get_search_suggestions(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"搜索建议生成失败: {str(e)}")
        ...
        async def patent_intelligent_search(
            ...
            try:
                ...
                return {
                    ...
                    'sources': list(set(r['source_type'] for r in results)),
                    'timestamp': datetime.now().isoformat()
                }

            except Exception as e:
                raise HTTPException(status_code=500, detail=f"专利智能搜索失败: {str(e)}")
        ...
        async def cross_domain_search(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"跨领域搜索失败: {str(e)}")
